...
import DateRangePicker, { DateRangeChangeEvent } from '@/components/DateRangePicker';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        {dashboardData && !loading && (
          <div className="space-y-8">
            ...
            <DashboardChart
              ...
              groupBy={groupBy}
              title={groupBy === 'daily' ? 'Daily Clicks Trend' : 'Weekly Clicks Trend'}
              height={400}
            />
        ...
        {/* Empty State (No Data) */}
        {dashboardData && !loading && dashboardData.totalClicks === 0 && (
          <div className="rounded-lg border border-gray-200 bg-white p-12 text-center shadow-sm">
            <div className="text-gray-500">
              <p className="text-lg font-semibold">No data in this period</p>
              <p className="text-sm mt-1">
                Create some short URLs and share them to start seeing analytics
              </p>
              <button
                onClick={() => router.push('/')}
                className="mt-6 px-6 py-2 rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-700 transition-colors"
              >
                Create Short URL
              </button>
            </div>
