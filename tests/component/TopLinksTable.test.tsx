...
describe('TopLinksTable Component', () => {
  ...
  describe('Sorting', () => {
    ...
    it('should allow sorting by click count ascending', () => {
      ...
      const sortButton = screen.getAllByText(/click|sort/i).find(el =>
  ...
  describe('User Interaction', () => {
    ...
    it('should be able to navigate to link details', () => {
      ...
      expect(firstCode.closest('a') || firstCode.closest('[role="button"]')).toBeTruthy();
    });
  });
  ...
  describe('Data Formatting', () => {
    ...
    it('should truncate long URLs', () => {
      const longUrlLinks = [
        {
          code: 'test',
          destination_url: 'https://example.com/very/long/url/that/goes/on/and/on/and/on/forever/and/ever',
          click_count: 10,
        },
      ];
    ...
    it('should show full URL on hover', () => {
      ...
      expect(urlElement.getAttribute('title') || urlElement.parentElement?.getAttribute('title')).toBeTruthy();
    });
  });
  ...
  describe('Accessibility', () => {
    ...
    it('should support keyboard navigation', () => {
      ...
      const tabbableElements = container.querySelectorAll('[tabindex], a, button');
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle special characters in URLs', () => {
      const specialLinks = [
        {
          code: 'spec',
          destination_url: 'https://example.com/path?query=value&other=123#anchor',
          click_count: 10,
        },
      ];
